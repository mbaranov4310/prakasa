...
export const ddv39: Chapter = {
  ...
  glossary: [
    { term: 'pratītikāla', meaning: 'the time of appearing' },
    ...
    { term: 'svapnaprabuddhasya', meaning: 'of one awakened from dream' },
  ...
  root: group('ddv-39-verse', 'verse', 'These two are apparent because they existed only during the time of appearing. One awakened from a dream has no standing of those two again in dream.', [
    ...
    word('ddv-39-w1', 'the time of appearing', [
      ['प्र', 'pra'],
      ['ती', 'tī'],
      ['ति', 'ti'],
      ['का', 'kā'],
    ...
    word('ddv-39-w3', 'these two', [
      ['ते', 'te'],
    ]),
    word('ddv-39-w4', 'because they stood (then)', [
      ['स्थि', 'sthi'],
      ['त', 'ta'],
      ['त्वा', 'tvā'],
      ['त्', 't'],
    ]),
    word('ddv-39-w5', 'in the apparent (order)', [
      ['प्रा', 'prā'],
      ['ति', 'ti'],
      ['भा', 'bhā'],
      ['सि', 'si'],
    ...
    word('ddv-39-w7', 'indeed', [
      ['हि', 'hi'],
    ]),
    word('ddv-39-w8', 'of one awakened from dream', [
      ['स्व', 'sva'],
      ['प्न', 'pna'],
      ['प्र', 'pra'],
      ['बु', 'bu'],
    ...
    word('ddv-39-w9', 'again', [
      ['पु', 'pu'],
      ['नः', 'naḥ'],
    ]),
    word('ddv-39-w10', 'in dream', [
      ['स्व', 'sva'],
      ['प्ने', 'pne'],
    ]),
    word('ddv-39-w11', 'is the standing', [
      ['स्थि', 'sthi'],
      ['ति', 'ti'],
      ['स्', 's'],
    ], { trailing: '' }),
    word('ddv-39-w12', 'of those two', [
      ['त', 'ta'],
      ['योः', 'yoḥ'],
    ], { trailing: ' ॥', lineBreakAfter: true }),
    ]),
